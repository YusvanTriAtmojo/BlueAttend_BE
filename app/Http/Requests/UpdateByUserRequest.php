...
class UpdateByUserRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'nama.max' => 'Nama user maksimal 30 karakter.',
            ...
            'foto_profile.mimes' => 'Format foto harus jpeg, jpg, atau png.',
        ];
    }
}